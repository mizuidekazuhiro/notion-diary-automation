...
class DailyLogSummary:
    ...
    workout_sessions: Optional[int] = None
    workout_gym: Optional[str] = None
    workout_duration_min: Optional[float] = None
    workout_sets: Optional[int] = None
    workout_volume_kg: Optional[float] = None
    workout_calories: Optional[float] = None
    workout_exercises: Optional[str] = None
...
def read_daily_log(
    *, daily_log_read_url: str, target_date: str, bearer_token: Optional[str]
    ...
    return DailyLogSummary(
        ...
        workout_done=_safe_bool(_get_case_insensitive_value(payload, "Workout Done", "workout_done")),
        workout_sessions=_safe_int(_get_case_insensitive_value(payload, "Workout Sessions", "workout_sessions")),
        workout_gym=_safe_text(_get_case_insensitive_value(payload, "Workout Gym", "workout_gym")),
        workout_duration_min=_safe_float(_get_case_insensitive_value(payload, "Workout Duration Min", "workout_duration_min")),
        workout_sets=_safe_int(_get_case_insensitive_value(payload, "Workout Sets", "workout_sets")),
        workout_volume_kg=_safe_float(_get_case_insensitive_value(payload, "Workout Volume Kg", "workout_volume_kg")),
        workout_calories=_safe_float(_get_case_insensitive_value(payload, "Workout Calories", "workout_calories")),
        workout_exercises=_safe_text(_get_case_insensitive_value(payload, "Workout Exercises", "workout_exercises")),
        workout_summary=_safe_text(_get_case_insensitive_value(payload, "Workout Summary", "workout_summary")),
