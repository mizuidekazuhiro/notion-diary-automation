...
def main() -> int:
    ...
    core = {
        "Mail Input Hash": {"rich_text", "text"},
        "Mail Input Snapshot": {"rich_text", "text"},
        "Mail Sent At": {"date"},
        "Mail Version": {"number"},
        "Diary Notification Sent": {"checkbox"},
        "Diary Notification Hash": {"rich_text", "text"},
        ...
        "Weather": {"rich_text", "text", "select"},
        "Weather Summary": {"rich_text", "text"},
        "Weather Location": {"rich_text", "text"},
        "Weather Temp Max C": {"number"},
        "Weather Temp Min C": {"number"},
        "Weather Precip Probability Max": {"number"},
        "Weather Code": {"number"},
        "Weather Input Hash": {"rich_text", "text"},
        "Weather Retrieved At": {"date"},
        "Weather Generated At": {"date"},
    }
