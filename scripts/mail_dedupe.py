...
def build_mail_input_snapshot(summary: Any, *, expense_f_alert: dict[str, Any], f_risk_alert: dict[str, Any]) -> dict[str, Any]:
    ...
    raw: dict[str, Any] = {
        ...
        "workout_done": getattr(summary, "workout_done", None),
        "workout_sessions": getattr(summary, "workout_sessions", None),
        "workout_gym": getattr(summary, "workout_gym", None),
        "workout_duration_min": getattr(summary, "workout_duration_min", None),
        "workout_sets": getattr(summary, "workout_sets", None),
        "workout_volume_kg": getattr(summary, "workout_volume_kg", None),
        "workout_calories": getattr(summary, "workout_calories", None),
        "workout_exercises": getattr(summary, "workout_exercises", None),
        "workout_summary": getattr(summary, "workout_summary", None),
        "f_risk_alert": {
            "matched": f_risk_alert.get("matched"),
            "score": f_risk_alert.get("score"),
            "reason": f_risk_alert.get("reason"),
            "alert_text": f_risk_alert.get("alert_text"),
            "summary": f_risk_alert.get("summary"),
            "matched_patterns": f_risk_alert.get("matched_patterns"),
            "input_hash": f_risk_alert.get("input_hash"),
            "no_alert_reason": f_risk_alert.get("no_alert_reason"),
            "skip_reason": f_risk_alert.get("skip_reason"),
        },
        "expense_f_alert": {
            "matched": expense_f_alert.get("matched"),
            "count": expense_f_alert.get("count"),
            "total": expense_f_alert.get("total"),
            "merchants": expense_f_alert.get("merchants"),
            "alert_text": expense_f_alert.get("alert_text"),
            "summary": expense_f_alert.get("summary"),
            "data_status": expense_f_alert.get("data_status"),
            "filter_strategy": expense_f_alert.get("filter_strategy"),
        },
    }
